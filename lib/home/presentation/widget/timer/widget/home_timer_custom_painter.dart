...
class HomeTimerCustomPainter extends CustomPainter {
  HomeTimerCustomPainter({
    this.animation,
    this.fillColor,
    this.fillGradient,
    this.ringColor,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(size.center(Offset.zero), size.width / 2, paint..strokeWidth = 4);
    ...
    canvas.drawArc(Offset.zero & size, startAngle, progress, false, paint..strokeWidth = 6);
  ...
  @override
  bool shouldRepaint(HomeTimerCustomPainter oldDelegate) {
