...
class SelfCareMyRoutineEditScreen extends StatefulWidget {
  const SelfCareMyRoutineEditScreen({Key? key}) : super(key: key);

  @override
  State<SelfCareMyRoutineEditScreen> createState() =>
      _SelfCareMyRoutineEditScreenState();
}

class _SelfCareMyRoutineEditScreenState
    extends State<SelfCareMyRoutineEditScreen> {
