...
final selfCarePurposeCreateProvider = StateNotifierProvider<
    SelfCarePurposeCreatePurposesStateNotifier, AsyncValue<int?>>(
  (ref) => SelfCarePurposeCreatePurposesStateNotifier(),
);
