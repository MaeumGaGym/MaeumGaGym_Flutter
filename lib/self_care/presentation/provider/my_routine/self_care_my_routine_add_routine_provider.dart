...
final selfCareMyRoutineAddRoutineProvider = StateNotifierProvider<
    SelfCareMyRoutineAddRoutineStateNotifier,
    AsyncValue<int?>>((ref) => SelfCareMyRoutineAddRoutineStateNotifier());
